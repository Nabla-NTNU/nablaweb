# ERSTATTER subscription.py I /usr/local/lib/python2.7/dist-packages/pybbm-0.8.0-py2.7.egg/pybb (ALLEREDE GJORT PAA GAUSS)
...
#                lang = user.get_profile().language or dict(settings.LANGUAGES)[settings.LANGUAGE_CODE.split('-')[0]]
                lang = user.get_profile().language or dict(settings.LANGUAGES)['en']
