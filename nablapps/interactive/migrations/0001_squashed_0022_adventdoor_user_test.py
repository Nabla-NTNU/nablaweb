    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, editable=False, blank=True, verbose_name='Opprettet av', to=settings.AUTH_USER_MODEL, related_name='quiz_created', on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(null=True, editable=False, blank=True, verbose_name='Endret av', to=settings.AUTH_USER_MODEL, related_name='quiz_edited', on_delete=models.CASCADE)),
                ('scoreboard', models.OneToOneField(null=True, to='interactive.QuizScoreboard', related_name='quiz', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(to='interactive.Quiz', related_name='questions', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='QuizReply',
            fields=[
                ('id', models.AutoField(serialize=False, verbose_name='ID', primary_key=True, auto_created=True)),
                ('scoreboard', models.ForeignKey(to='interactive.QuizScoreboard', related_name='replies', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='interaction_results', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(to='interactive.QuizQuestion', on_delete=models.CASCADE)),
                ('quiz_reply', models.ForeignKey(null=True, to='interactive.QuizReply', related_name='questions', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Test',
            fields=[
                ...
                ('last_changed_date', models.DateTimeField(null=True, auto_now=True, verbose_name='Redigeringsdato')),
                ('template', models.CharField(max_length=100, verbose_name='Template', default='interactive/advent_door_base.html')),
                ('created_by', models.ForeignKey(null=True, editable=False, blank=True, verbose_name='Opprettet av', to=settings.AUTH_USER_MODEL, related_name='test_created', on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(null=True, editable=False, blank=True, verbose_name='Endret av', to=settings.AUTH_USER_MODEL, related_name='test_edited', on_delete=models.CASCADE)),
                ('publication_date', models.DateTimeField(null=True, verbose_name='Publikasjonstid', blank=True)),
                ('published', models.NullBooleanField(verbose_name='Publisert', help_text='Dato har høyere prioritet enn dette feltet.', default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(null=True, to='interactive.Test', related_name='questions', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test', models.ForeignKey(null=True, to='interactive.Test', related_name='results', on_delete=models.CASCADE)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(null=True, to='interactive.TestQuestion', related_name='alternatives', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calendar', models.ForeignKey(verbose_name='Kalender', to='interactive.AdventCalendar', on_delete=models.CASCADE)),
                ('committee', models.ForeignKey(null=True, blank=True, verbose_name='Komité', to='com.Committee', on_delete=models.CASCADE)),
                ('created_by', models.ForeignKey(null=True, editable=False, blank=True, verbose_name='Opprettet av', to=settings.AUTH_USER_MODEL, related_name='adventdoor_created', on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(null=True, editable=False, blank=True, verbose_name='Endret av', to=settings.AUTH_USER_MODEL, related_name='adventdoor_edited', on_delete=models.CASCADE)),
                ('winner', models.ForeignKey(null=True, blank=True, verbose_name='Vinner', to=settings.AUTH_USER_MODEL, related_name='advent_doors_won', on_delete=models.CASCADE)),
                ...
                ('quiz', models.ForeignKey(null=True, blank=True, verbose_name='Lenket quiz', to='interactive.Quiz', on_delete=models.CASCADE)),
                ('user_test', models.ForeignKey(null=True, blank=True, verbose_name='Lenket brukertest', to='interactive.Test', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('door', models.ForeignKey(to='interactive.AdventDoor', related_name='participation', on_delete=models.CASCADE)),
