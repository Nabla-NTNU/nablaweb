    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_changed_date",
                    models.DateTimeField(
                        null=True, auto_now=True, verbose_name="Redigeringsdato"
                    ),
                ),
                (
                    "template",
                ...
                (
                    "is_timed",
                    models.BooleanField(
                        verbose_name="Bruk tidsbegrensning?", default=False
                    ),
                ),
                (
                    "duration",
                ...
                (
                    "publication_date",
                    models.DateTimeField(
                        null=True, verbose_name="Publikasjonstid", blank=True
                    ),
                ),
                (
                    "published",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alternative_1",
                    models.CharField(max_length=200, verbose_name="Alternativ 1"),
                ),
                (
                    "alternative_2",
                    models.CharField(max_length=200, verbose_name="Alternativ 2"),
                ),
                (
                    "alternative_3",
                    models.CharField(max_length=200, verbose_name="Alternativ 3"),
                ),
                (
                    "alternative_4",
                    models.CharField(max_length=200, verbose_name="Alternativ 4"),
                ),
                (
                    "quiz",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question",
                    models.ForeignKey(
                        to="interactive.QuizQuestion", on_delete=models.CASCADE
                    ),
                ),
                (
                    "quiz_reply",
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        validators=[
                            nablapps.interactive.models.user_test.validate_weight_syntax
                        ],
                        blank=True,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Opprettet av",
                        to=settings.AUTH_USER_MODEL,
                        related_name="adventdoor_created",
                        on_delete=models.CASCADE,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        verbose_name="Endret av",
                        to=settings.AUTH_USER_MODEL,
                        related_name="adventdoor_edited",
                        on_delete=models.CASCADE,
                    ),
                ),
                (
                ...
                (
                    "is_lottery",
                    models.BooleanField(verbose_name="Har trekning", default=False),
                ),
                (
                    "short_description",
                    models.CharField(
                ...
                (
                    "is_text_response",
                    models.BooleanField(verbose_name="Har tekstsvar", default=False),
                ),
                (
                    "image",
                    models.ImageField(
                        null=True, verbose_name="Bilde", blank=True, upload_to=""
                    ),
                ),
                (
                    "quiz",
