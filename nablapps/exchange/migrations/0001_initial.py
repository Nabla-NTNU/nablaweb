...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, verbose_name='ID', auto_created=True)),
                ('univ_navn', models.CharField(default='', max_length=50, help_text='Navnet til universitetet', verbose_name='universitets navn')),
                ('desc', models.TextField(blank=True, help_text='En kort beskrivelse av universitetet. Valgfritt.', verbose_name='beskrivelse')),
                ('land', models.CharField(default='', max_length=30, help_text='Landet universitetet ligger i', verbose_name='land')),
            ],
            options={
                'ordering': ['univ_navn'],
