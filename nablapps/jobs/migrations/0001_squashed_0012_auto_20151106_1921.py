    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='company_created', to=settings.AUTH_USER_MODEL, verbose_name='Opprettet av', blank=True, null=True, editable=False, on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(related_name='company_edited', to=settings.AUTH_USER_MODEL, verbose_name='Endret av', blank=True, null=True, editable=False, on_delete=models.CASCADE)),
                ...
                ('content_type', models.ForeignKey(to='contenttypes.ContentType', editable=False, null=True, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Advert',
            fields=[
                ('news_ptr', models.OneToOneField(auto_created=True, parent_link=True, primary_key=True, serialize=False, to='news.News', on_delete=models.CASCADE)),
                ...
                ('company', models.ForeignKey(verbose_name='Bedrift', help_text='Hvilken bedrift stillingen er hos', to='jobs.Company', on_delete=models.CASCADE)),
