...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='BedPres',
            fields=[
                ('news_ptr', models.OneToOneField(to='news.News', primary_key=True, parent_link=True, serialize=False, auto_created=True, on_delete=models.CASCADE)),
                ...
                ('company', models.ForeignKey(help_text='Hvilken bedrift som står bak bedriftspresentasjonen', to='jobs.Company', verbose_name='Bedrift', on_delete=models.CASCADE)),
