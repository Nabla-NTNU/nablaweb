    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='news_created', editable=False, blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Opprettet av', null=True, on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(related_name='news_edited', editable=False, blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Endret av', null=True, on_delete=models.CASCADE)),
