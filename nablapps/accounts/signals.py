...
def login_message(sender, request, user, **kwargs):
    with suppress(MessageFailure):
        ...
        msg = f"Vil du få sjansen til å vinne gavekort på 250 kr, og mange andre kule premier? Sjekk ut innkallingen til eSKE da vel! " #reklame eSKE/SKE - fjernes etter
