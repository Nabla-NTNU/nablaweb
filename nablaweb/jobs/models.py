...
class Advert(Content):
    ...
    picture = models.ImageField(upload_to="job_advert_pictures", null=True, blank=True, verbose_name="Bilde", help_text="Relevant bilde")

    headline = models.CharField(max_length=200, blank=False, verbose_name="tittel", help_text="Overskrift")
    lead_paragraph = models.TextField(verbose_name="ingress", blank=True, help_text="Ingress")
    body = models.TextField(verbose_name="beskrivelse", blank=True, help_text="Beskrivelse av stillingen")
