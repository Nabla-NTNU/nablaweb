...
urlpatterns = patterns('',
    ...
    url(r'^bedrift/(?P<slug>[-\w]*)$', CompanyList.as_view(), name='company_detail'), # Stillingsannonser fra én bedrift
    url(r'^linje/(?P<linje>\w{1,50})/$', RelevantForLinjeList.as_view(), name='relevant_for_linje_list'),
