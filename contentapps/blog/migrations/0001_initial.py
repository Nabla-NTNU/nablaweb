    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateField(verbose_name='Opprettet', auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(related_name='posts', to='blog.Blog', verbose_name='Blogg', on_delete=models.CASCADE)),
                ('created_by', models.ForeignKey(related_name='blogpost_created', editable=False, blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Opprettet av', null=True, on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(related_name='blogpost_edited', editable=False, blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Endret av', null=True, on_delete=models.CASCADE)),
