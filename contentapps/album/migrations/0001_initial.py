    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='album_created', editable=False, blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Opprettet av', null=True, on_delete=models.CASCADE)),
                ('last_changed_by', models.ForeignKey(related_name='album_edited', editable=False, blank=True, to=settings.AUTH_USER_MODEL, verbose_name='Endret av', null=True, on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(related_name='images', to='album.Album', verbose_name='Album', null=True, on_delete=models.CASCADE)),
